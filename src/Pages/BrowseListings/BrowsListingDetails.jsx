...
export const BrowsListingDetails = () => {
  ...
  const handleLike = async () => {
    ...
    const res = await fetch(
      `https://roommate-serverside.vercel.app/browse-listings/details/${_id}/like`,
      {
        method: "PATCH",
      }
    );
        ...
        <div className="card-body card card-dash bg-base-200">
          ...
          <div className="my-4 w-full">
            <button
              ...
              className="relative w-full px-5 py-3 overflow-hidden font-medium text-gray-600 bg-gray-100 border border-gray-100 rounded-lg shadow-inner group hover:cursor-pointer"
            >
