...
export const FindRoommate = () => {
    ...
    // console.log(user, userEmail, displayName)
        ...
        <div className='my-6'>
            ...
            <form onSubmit={handleAddToFindRoommate} className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                ...
                <fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-full border p-4">
                    ...
                    <input type="email" name='email' className="input w-full" value={userEmail} placeholder="User Email ( you can not edit this field)" required readOnly />
                </fieldset>
                <fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-full border p-4">
                    <label className="label">User Name</label>
                    <input type="text" name='name' className="input w-full" value={displayName} placeholder="User Name ( you can not edit this field) " required readOnly />
                </fieldset>
                <div className='md:col-span-2 col-span-1 w-full'>
                    ...
                    <button type='submit' className="px-5 py-2.5 relative rounded group text-white font-medium inline-block w-full hover:cursor-pointer">
                        ...
                        <span className="relative">Post For Roommates</span>
                    </button>
                </div>
            </form>
        </div>
