...
export const Details = () => {
  ...
  const handleLike = async () => {
    ...
    const res = await fetch(
      `https://roommate-serverside.vercel.app/details/${_id}/like`,
      {
        method: "PATCH",
      }
    );
  ...
  return (
    <>
      ...
      >
        ...
        <div className="hero-content text-neutral-content text-center">
          <div className="text-center">
            ...
            <button className="btn bg-[#50E3C2] hover:bg-[#30C9A2] transition duration-300 ease-in-out hover:text-white">
              Get Started
            </button>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className="text-center text-2xl font-bold text-[#F2C94C] my-5">
          {title}
        </h1>
      </div>
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
        <div className="card-body card card-dash bg-base-200 shadow-xl/30">
          <div className="flex justify-between bg-green-200 p-6 rounded-2xl">
            <div className="text-center">
              <p className="text-base md:text-lg text-[#969696] mb-[-4px]">
                Price/Month
              </p>
              <h2 className="card-title font-semibold text-lg md:text-xl">
                tk- {rent} taka
              </h2>
            </div>
            <div className="text-center">
          ...
          <div className="flex justify-between bg-green-200 p-6 rounded-2xl">
            ...
            <div className="text-center">
              ...
              {showContract ? (
                <h2
                  id="contact"
                  className="card-title font-semibold text-lg md:text-xl"
                >
                  {contact}
                </h2>
              ) : (
                <h2
                  id="contactTitle"
                  className="card-title font-semibold text-lg"
                >
                  Like page to see contact
                </h2>
              )}
            </div>
          </div>
          ...
          <div className="my-4 w-full">
            <button
              ...
              class="relative w-full px-5 py-3 overflow-hidden font-medium text-gray-600 bg-gray-100 border border-gray-100 rounded-lg shadow-inner group hover:cursor-pointer"
            >
              ...
              <span className="relative text-2xl font-semibold transition-colors duration-300 delay-200 group-hover:text-white ease">
                Confirm
              </span>
            </button>
          </div>
        ...
        <div>
            ...
            <div className="my-4">
              <fieldset className="fieldset">
                <textarea
                  ...
                  placeholder={`Write message to ${name}`}
                ></textarea>
              </fieldset>
              <button
                onClick={handleSendMessage}
                className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 bg-gray-900 rounded-lg hover:bg-gray-800 focus:shadow-outline focus:outline-none hover:cursor-pointer mt-6"
              >
                Message
              </button>
            </div>
          ...
          <div
            className="flex justify-center items-center bg-base-200 rounded-xl p-4 my-6 w-full max-w-md mx-auto 
